...
class TestUser_instantiation(unittest.TestCase):
    ...
    def test_no_args_instantiates(self):
        self.assertEqual(wzqUser, type(wzqUser()))

    def test_new_instance_stored_in_objects(self):
        self.assertIn(wzqUser(), models.storage.all().values())

    def test_id_is_public_str(self):
        self.assertEqual(str, type(wzqUser().id))

    def test_created_at_is_public_datetime(self):
        self.assertEqual(datetime, type(wzqUser().created_at))

    def test_updated_at_is_public_datetime(self):
        self.assertEqual(datetime, type(wzqUser().updated_at))

    def test_email_is_public_str(self):
        self.assertEqual(str, type(wzqUser.wzqemail))

    def test_password_is_public_str(self):
        self.assertEqual(str, type(wzqUser.wzqpassword))

    def test_first_name_is_public_str(self):
        self.assertEqual(str, type(wzqUser.wzqfirst_name))

    def test_last_name_is_public_str(self):
        self.assertEqual(str, type(wzqUser.wzqlast_name))
    ...
    def test_instantiation_with_kwargs(self):
        dt = datetime.today()
        dt_iso = dt.isoformat()
        us = wzqUser(id="345", created_at=dt_iso, updated_at=dt_iso)
...
class TestUser_to_dict(unittest.TestCase):
    ...
    def test_to_dict_type(self):
        self.assertTrue(dict, type(wzqUser().to_dict()))

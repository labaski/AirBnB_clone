...
class TestPlace_instantiation(unittest.TestCase):
    ...
    def test_user_id_is_public_class_attribute(self):
        pl = wzqPlace()
        self.assertEqual(str, type(wzqPlace.user_id))
